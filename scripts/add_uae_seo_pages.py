...
def page_html(page):
    ...
    breadcrumb_schema = json.dumps({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://jobpick20.com/"},{"@type":"ListItem","position":2,"name":"UAE jobs","item":"https://jobpick20.com/jobs-in-uae/"},{"@type":"ListItem","position":3,"name":page['h1'],"item":url}]}, ensure_ascii=False, separators=(',', ':'))
